<?php $title = "sujets selon l'auteur"; ?>
    ...
    <section class="forum_section">
        ...
        if (isset($_GET['cat_id']) && isset($_GET['subcat_id'])):?>
            ...
            <div class="text-center">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Modifier le sujet</button>
            </div>
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
        ...
        <table class="table table-striped">
            ...
            while($data = $topics->fetch()):
                ...
                <tr class="text-center">
                    ...
                    <td data-title="Date de creation">  Créé le <?= $data['created']; ?>
                    </td>
                </tr>
